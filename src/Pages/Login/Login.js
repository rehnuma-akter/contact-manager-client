        ...
        <div className='flex h-screen justify-center items-center '>
            <div className="card w-96 bg-base-100 shadow-xl">
                <div className="card-body">
                    ...
                    {signInError}
                    <input className='btn w-full max-w-xs text-white bg-secondary hover:bg-secondary-focus' type="submit" value="Login" />
                    </form>
                    <p><small>New to Contact Ninja? <Link className='text-primary-focus' to="/register">Create New Account</Link></small></p>
